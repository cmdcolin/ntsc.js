...
export const GROUPS: Group[] = [
  ...
  },
  {
    ...
    sliders: [
      ...
      {
        key: 'impulseRate',
        label: 'impulse noise (sparks)',
        min: 0,
        max: 300,
        step: 1,
        unit: '/frame',
        help: 'Impulse interference — ignition, an arcing thermostat, a dying flyback next door. The opposite texture from snow: sparse microsecond events at carrier-scale amplitude, each a bright comet with an instant attack and a ringing tail, scattered at random over the raster. Land enough of them on a sync tip or the burst and timing and colour take the hit too. On a dark picture with phosphor persistence they read as single photons slamming the glass.',
      },
      {
        key: 'impulseIre',

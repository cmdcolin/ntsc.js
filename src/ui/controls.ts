  ...
  },
  {
    ...
    sliders: [
      ...
      },
      {
        ...
        step: 0.01,
        unit: '',
        help: 'A loop is a loop because someone joined the ends, and the joint passes the play head once per lap — the head lifts for the three lines it takes to cross. Since a loop is rarely a whole number of frames long, the bump walks down the picture lap by lap: a metronome you can see, ticking at the delay time.',
      },
      {
        key: 'tapeWowPct',

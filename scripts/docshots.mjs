...
const LIVE_BASE = 'https://cmdcolin.github.io/ntscythe/'
...
const SEED = {
  ntscythe_overlay_bar_hidden: '0',
  ntscythe_fps_hidden: '0',
...
const tmpDir = mkdtempSync(join(tmpdir(), 'ntscythe-docshots-'))
